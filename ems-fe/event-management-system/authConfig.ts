...
const flows = {
    localAccSignIn: 'B2C_1_Sign_In_Sign_Up', //e.g., B2C_1_main_flow
}
...
export const msalConfig = {
    auth: {
        ...
        knownAuthorities: ["manageeventgroup.b2clogin.com"], // Mark your B2C tenant's domain as trusted.
...
export const authScopes = {
    scopes: ['https://manageeventgroup.onmicrosoft.com/b7c4f595-0385-48a2-9fa6-7b375bb0721f/Access.FullAccess']
};